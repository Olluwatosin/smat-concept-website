      ...
      <section className="section-divider py-20" style={{ backgroundColor: "#0C0F1E" }}>
        <div className="max-w-5xl mx-auto px-6">
          ...
          <motion.div
            ...
            className="relative rounded-2xl overflow-hidden mb-12 h-56 md:h-72"
            style={{ border: "1px solid rgba(212,175,55,0.18)", background: "radial-gradient(ellipse 70% 60% at 85% 20%, rgba(212,175,55,0.12) 0%, transparent 60%), linear-gradient(135deg, #101830 0%, #0B1020 60%, #080B16 100%)" }}
          >
            <div className="absolute inset-0 dot-grid opacity-40" />
            <Camera className="absolute -bottom-6 -right-4 w-40 h-40" style={{ color: "rgba(212,175,55,0.10)" }} strokeWidth={1.2} aria-hidden />
